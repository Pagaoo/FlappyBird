...
class Passaro:
    ...
    def __init__(self, x, y):
        ...
        self.y = y
        self.angulo = 0
        self.velocidade = 0  # Velocida pra cima e pra baixo da animação do passáro
        self.altura = self.y
        self.tempo = 0
        self.contagem_img = 0  # Qual imagem do passáro está sendo usada
        self.img = self.IMGS[0]

    # O Y no pygames é ao contrario do que estamos acostumados, positivos para baixo, negativos para cima
    def pular(self):
    ...
    def desenhar(self, tela):
        # Definir qual img do passáro irá usar
        self.contagem_img += 1
        ...
        # Passáro tiver caindo, não bater a asa
        if self.angulo <= -80:
            self.img = self.IMGS[1]
...
class Cano:
    ...
    def __init__(self, x):
        ...
        self.pos_topo = 0
        self.pos_base = 0
        self.CANO_TOPO = pygame.transform.flip(IMAGEM_CANO, False, True)  # False para flip no eixo x e True para flip no y
...
def main(genomas, config):  # Fitness Function
    ...
    while rodando:
        ...
        for i, passaro in enumerate(passaros):
            ...
            # -1 e 1 -> se o output for > 0.5 o passáro pula
            if output[0] > 0.5:
                passaro.pular()
        chao.mover()
...
def rodar(caminho_config):
    ...
    if ai_jogando:
        populacao.run(main, 50)  # Roda só até 50 gerações
    else:
        main(None, None)
